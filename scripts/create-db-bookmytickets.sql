DROP DATABASE IF EXISTS `bookmytickets`;
...
--
-- Table strcuture for discounts table
--
...
CREATE TABLE `flight_schedule` (
  ...
  CONSTRAINT `FK_NET_FARE` 
  FOREIGN KEY (`net_fare`) 
  REFERENCES `air_fare` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
